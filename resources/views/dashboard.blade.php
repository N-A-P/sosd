...
float: right;
font-size: 16px;"> Last access : 26 Sep 2018 &nbsp; <!--<a href="#" class="btn btn-danger square-btn-adjust">Logout</a>--> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                   ...
                   <!-- <li>
                    ...
                    <li >
                        <a  href="index.html"><i class="fa fa-square-o fa-3x"></i> Dashboard </a>
                    </li>				
					
					                   
                    <li>
                        <a href="table.html"><i class="fa fa-square-o fa-3x"></i> Danh sách người giúp việc</a>
                        
                      </li>  
                  <li  >
                        <a  href="table1.html"><i class="fa fa-square-o fa-3x"></i> Quản lý người dùng</a>
                    </li>	
                     <li  >
                        <a  href="blank.html"><i class="fa fa-square-o fa-3x"></i> Phản hồi liên hệ</a>
                    </li>
                </ul>
